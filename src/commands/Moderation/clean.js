...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (args.length > 1) {
            ...
            let target = '', flagUsers = false, flagBots = false, flagNopin = false, flagHas = '', flagTo = 0;
            ...
            try {
                ...
                const res = await advanceClean(message, amount, {target:target, flagUsers:flagUsers, flagBots:flagBots, flagNopin:flagNopin, flagHas:flagHas, flagTo:flagTo});
