...
module.exports = {
    ...
    run(client, message) {
        ...
        .setDescription('• [Bot Invite](https://discord.com/api/oauth2/authorize?client_id=762359941121048616&permissions=2416438487&scope=bot%20applications.commands)\n• [Support Server](https://discord.gg/xcZwGhSy4G)\n• [Github Repo](https://github.com/devnote-dev/Radeon)')
        .setColor(0x1e143b)
